...
<script src="//cdn.polyfill.io/v1/polyfill.min.js?features=Array.from"></script>
 
<!-- The default set, plus the geolocation polyfill -->
<script src="//cdn.polyfill.io/v1/polyfill.min.js?features=default,Navigator.prototype.geolocation"></script>
	...
	pointer-events: none !important;
		...
		<div class="noop visual-focus-on" style="posion: relative">
			<div id="FONTS_CONTAINER">
				<link
					href="https://static.parastorage.com/services/santa-resources/resources/viewer/user-site-fonts/v5/languages.css"
			...
			<div id="SITE_BACKGROUND"
				style="top: 50px; height: 3958px; width: 1189px;"
				class="siteBackground">

				<div id="SITE_BACKGROUND_previous_noPrev"
					class="siteBackgroundprevious" style="width: 100%; height: 100%;">

					<div id="SITE_BACKGROUNDpreviousImage"
						class="siteBackgroundpreviousImage"></div>

					<div id="SITE_BACKGROUNDpreviousVideo"
						class="siteBackgroundpreviousVideo"></div>

					<div id="SITE_BACKGROUND_previousOverlay_noPrev"
						class="siteBackgroundpreviousOverlay"></div>
				</div>

				<div id="SITE_BACKGROUND_current_c1dmp_jnomnyo5_bg"
					style="top: 0px; background-color: rgb(255, 255, 255); position: absolute; width: 100%; height: 100%;"
					data-position="absolute" class="siteBackgroundcurrent">

					<div id="SITE_BACKGROUND_currentImage_c1dmp_jnomnyo5_bg"
					...
					<div id="SITE_BACKGROUNDcurrentVideo"
						class="siteBackgroundcurrentVideo"></div>

					<div id="SITE_BACKGROUND_currentOverlay_c1dmp_jnomnyo5_bg"
						style="position: absolute; top: 0; width: 100%; height: 100%"
						class="siteBackgroundcurrentOverlay"></div>
